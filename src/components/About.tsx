...
<div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 mt-40">
  ...
  <div className="relative ml-4">
    ...
    <div>
      <h3 className="block text-3xl font-bold text-black sm:text-2xl lg:text-4xl lg:leading-tight ">About Us</h3>
  ...
  <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center pt-40">
    ...
    <div>
      <h3 className="block text-3xl font-bold text-black sm:text-2xl lg:text-4xl lg:leading-tight ">Our values</h3>
